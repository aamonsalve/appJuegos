...
export class BackbuttonService {
  ...
  constructor(private platform: Platform,
    ...
    this.exitB.subscribe(() => {
      ...
      if (!this.openModal) {
        if (this.currentURL == "/" || this.currentURL == "" || this.currentURL == "/inicio" || this.currentURL == "/tabs" || this.currentURL == "/profesor/home" || this.currentURL == "/usuario" || this.currentURL == "/usuario/home")
